    ...
    var B = /:[0-9]+$/,
        ...
        F = function(a, b) {
            ...
            if ("protocol" === b || "port" === b)
                a.protocol = D(a.protocol) || D(y.location.protocol);
    ...
    function X(a, b, c) {
        if (c && c.action) {
            ...
            if ("get" === d) {
                ...
                "post" === d && (a = V(a, b, c.action), x.test(a) && (c.action = a))
        }
    }
    var ba = function(a) {
            try {
    ...
    */
    ...
    var bd = function(a) {
        ...
        ge = function(a, b, c) {
            ...
            ["t=error", "_e=" + a, "_v=j90", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(bd(!0) + "/u/d", a.join("&"), ua))
        };
    var qc = function() {
                        ...
                        if (c)
                            ...
                            if (d = c.indexOf("."), -1 == d)
                                ...
                                if (c = be("_gac", !!a.get(cc)))
                                    c = c.split("."),
                                    "1" != c[0] || 4 != c.length ? J(72) : ke(c[3], c[1]) ? J(71) :
